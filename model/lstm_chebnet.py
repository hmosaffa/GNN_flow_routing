...
class SimpleChebNetWithStatic(nn.Module):
    """2-layer ChebNet module for spatial processing with static feature integration."""
    
    def __init__(self, temporal_dim, static_dim, hidden_dim, output_dim, dropout=0.5, K=3, normalization='sym'):
        super(SimpleChebNetWithStatic, self).__init__()
...
class CombinedLSTMChebNetWithStatic(nn.Module):
    """
    Combined LSTM-ChebNet model for spatiotemporal forecasting.
    ...
    3. 2-Layer ChebNet: Propagates information using Chebyshev spectral graph convolution
    ...
    Args:
        ...
        gnn_hidden_dim (int): Hidden dimension for ChebNet
        output_dim (int): Output dimension (default: 1)
        lstm_layers (int): Number of LSTM layers (default: 2)
        cheb_K (int): Order of Chebyshev polynomials (1-10, higher = more global info)
        cheb_normalization (str): Normalization method ('sym' or 'rw')
        lstm_dropout (float): Dropout rate for LSTM (default: 0.2)
        gnn_dropout (float): Dropout rate for ChebNet (default: 0.2)
    """
    ...
    def __init__(
        ...
        super(CombinedLSTMChebNetWithStatic, self).__init__()
        ...
        self.gnn_module = SimpleChebNetWithStatic(
